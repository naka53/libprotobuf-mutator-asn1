...
int main(int argc, char **argv) {
    ...
    x509_certificate::RSAPrivateKey input;
    ...
    std::vector<uint8_t> asn1 = x509_certificate::RSAPrivateKeyToDER(input);

    std::ofstream fs("output.der", std::ios::out | std::ios::binary | std::ios::trunc);
